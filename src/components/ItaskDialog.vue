        ...
        <a-timeline-item v-for="(item, index) in list" :key="index">
          ...
          <div class="right-content">
            ...
            <div class="right-file">
              <div v-for="(subitem, subindex) in item[propData.fileGroupField || 'feedbackAttachFiles']" :key="subindex" :title="subitem.fileName"  @click.stop="handleOpen(subitem)">
...
export default {
  ...
  methods: {
    ...
    init() {
      console.log('获取数据', this.propData)
      this.initData()
      this.handleStyle()
