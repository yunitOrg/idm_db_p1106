    ...
    data() {
        return {
            ...
            columns: [
                ...
                { title: '收文号', dataIndex: 'extRelevanceWh', align: 'center', key: 'extRelevanceWh', width: '10%', sortField: 'extRelevanceWh' },
                { title: '编号', dataIndex: 'wh', align: 'center', key: 'wh', width: '10%', sortField: 'wh' },
                { title: '标题', dataIndex: 'bt', align: 'center', key: 'bt', width: '24%', sortField: 'bt', scopedSlots: { customRender: 'bt' } },
                { title: '督办类型', dataIndex: 'approvalTypeText', align: 'center', key: 'approvalTypeText', width: '10%', sortField: 'approvalType' },
                ...
                { title: '立项日期', dataIndex: 'ngrq', align: 'center', key: 'ngrq', width: '10%', sortField: 'ngrq' },
                { title: '交办日期', dataIndex: 'handoverDate', align: 'center', key: 'handoverDate', width: '10%', sortField: 'handoverDate' },
                // { title: '分管领导', dataIndex: 'directLeaderText', align: 'center', key: 'directLeaderText', width: '8%' },
                { title: '办结期限', dataIndex: 'endDate', align: 'center', key: 'endDate', width: '10%', sortField: 'endDate' },
                { title: '主办部门', dataIndex: 'hostStr', align: 'center', key: 'hostStr', width: '12%' },
